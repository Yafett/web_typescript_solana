...
function SendSol() {
    ...
    return (
        <div>
            <p className="text-2xl text-white-600 font-bold mb-5">SEND SOL</p>

            <div>
                <button className='group w-60 m-2 btn  bg-gradient-to-r from-[#9945FF] to-[#14F195] hover:from-pink-500 hover:to-yellow-500 ... ' onClick={wrapSol}>Wrap SOL</button>
                <button className='group w-60 m-2 btn  bg-gradient-to-r from-[#9945FF] to-[#14F195] hover:from-pink-500 hover:to-yellow-500 ... ' onClick={unwrapSol}>Unwrap SOL</button>
                <button className='group w-60 m-2 btn  bg-gradient-to-r from-[#9945FF] to-[#14F195] hover:from-pink-500 hover:to-yellow-500 ... ' onClick={sendSol}>Send SOL</button>
            </div>
        </div>
    );
}
